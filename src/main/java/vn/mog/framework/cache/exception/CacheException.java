...
/**
 * doc This class intends to add chained exception capability to JDK 1.3 please see: http://java.sun.com/j2se/1.4.2/docs/guide/lang/chained-exceptions.html (this capability is available in JDK 1.4.
 * How to achive it: using an array to store stacktrace of catched exception before.
 *
 * @author nghiemlong
 */
