...
<section class="body">
  ...
  <div class="inner-wrapper">
    ...
    <jsp:include page="../include_page/navigation.jsp">
      <jsp:param value="card_item" name="nav"/>
    </jsp:include>
    <!-- end: sidebar -->
          ...
          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="page-header-left">
              <ol class="breadcrumbs">
                ...
                <li><span class="nav-active"><spring:message code="common.title.card.item"/></span>
                </li>
              </ol>
            </div>
          </div>
      ...
      <div class="content-body-wrap">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pl-none">
          <div class="page-header-left header-title">
            <spring:message code="common.information.card.item"/>
          </div>
        </div>
            ...
            <div id="tab1" class="tab-pane active">
                    ...
                    <div class="d-flex justify-content-between">
                      ...
                      <div class="pull-right form-responsive bt-plt">
                        ...
                        <c:if test="${'true' eq MENU_ITEM_SHOW_CARD_STORE_OFF_LINE}">
                          ...
                          <select class="form-control hidden" name="poTypes" multiple="multiple"
                                  id="poType">
              ...
              <section class="panel search_payment panel-default">
                <div class="panel-body" style="padding-top: 0">
                  ...
                  <spring:message var="colType" code="purchase.table.type"/>
                  <spring:message var="colSerial" code="purchase.table.serial"/>
                  ...
                  <display:table name="list" id="list"
                    ...
                    <display:column title="${colType}"><a>${list.cardType}</a></display:column>
                    <display:column title="${colSerial}" property="serial"/>
                    <display:column title="${colPO}" property="poCode"/>
                    <c:if test="${'true' eq MENU_ITEM_SHOW_CARD_STORE_OFF_LINE}">
                    ...
                    <display:column title="${colFaceValue}" headerClass="col-number-header"
                                    class="col-number-header">${ewallet:formatNumber(list.faceValue)}</display:column>
